...
from layers import LocalGlobalConvolution
...
class LocalGlobalCNN(nn.Module):
    def __init__(
        ...
        self.emb = nn.Conv2d(in_c, n_channels, kernel_size=3, stride=1, padding="same")
        self.enc = nn.Sequential(
            *[
                LocalGlobalConvolutionEncoder(
                    input_shapes=(n_channels, img_size, img_size),
